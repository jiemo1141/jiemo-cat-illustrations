...
画法：左侧输入，中间小黑猫或怪机器处理，右侧输出，橙色箭头表达主流向。

### 系统局部

适合：信息来源、过滤器、数据库、渲染器、agent 系统局部。

画法：只画 3-5 个核心模块，小黑猫参与其中一个关键动作。
...
画法：一层层盒子，不要正式金字塔；小黑猫在旁边搬砖或蹲在层上。

### 地图路线

适合：从想法到上线、用户路径、内容承接路径、学习路线。

画法：一条弯曲路径，少量节点，小黑猫牵线或用尾巴指路。
...
3. 让小黑猫承担动作：不是站旁边，而是蹲在机器里、用爪子扒拉线、守门、搬运、修补、称重、推东西、把东西塞进某个怪装置。
...
- 扒、推、扛、塞、捞、压、称、缝、剪、拧、守、接、拆、标记、卷（用尾巴）。
- 动作要服务核心意思，不要为了怪而怪。

## 反复刻规则

除非用户明确说"照这张 / 复刻这个构图"，否则不要直接复用旧构图。
